...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMapPin, IconMenu2, IconSettings } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

const APP_TITLE = 'Bilderverwaltung';
...
const navigation = [
  ...
  { name: 'Bilder', href: '/bilder', icon: IconFileText },
  { name: 'Standorte', href: '/standorte', icon: IconMapPin },
];

const externalNavigation = [
  { name: 'Bilder', href: '/gateway/apps/6822e973c07d98c861cb2db6?template=list_page', icon: IconFileText },
  { name: 'Standorte', href: '/gateway/apps/6822e9709bf15c1e2a8dca33?template=list_page', icon: IconMapPin },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/6822e973c07d98c861cb2db6?template=list_page"
